                             ...
                             PyObject *callback_obj, int flags)
{
    ...
    if ((flags & CCALLBACK_PARSE) && lowlevelcallable_type != NULL &&
    ...
    else if ((lowlevelcallable_type != NULL && PyObject_TypeCheck(callback_obj, lowlevelcallable_type) &&
    ...
    else if (PyCapsule_CheckExact(callback_obj)) {
        void *ptr, *user_data;
        ccallback_signature_t *sig;
        const char *name;
